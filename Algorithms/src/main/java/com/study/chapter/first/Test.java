...
public class Test {
    public static void main(String[] args) {
        ...
        // });
        // com.chapter.first.StopWatch stopWatch = new com.chapter.first.StopWatch();
        // int N = 100000000;
        // int sum = 0;
        // for (int i = 0; i > 0; i/=2) {
        //     for (int j = 0; j < i; j++) {
        ...
        // drawPie(10, 0.1);
        // com.chapter.first.Test.test1();
        // com.chapter.first.Test.test2();
        // com.chapter.first.Test.test3();
        // com.chapter.first.Test.test4();
        // com.chapter.first.Test.test5();
        // com.chapter.first.Test.test6();
        // System.out.println(com.chapter.first.Test.lg(5));
        // int[] a = {1, 2, 1, 1, 1,};
        ...
        // new com.chapter.first.Test().sortArrayByParity(new int[]{3, 1, 2, 4});
        // new com.chapter.first.Test().uniqueMorseRepresentations(new String[]{
        //         "gin"
        // });
